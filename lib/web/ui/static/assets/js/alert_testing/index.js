...
function mustacheFormatDate(timestamp) {
    ...
    if (date.valueOf() === -62135596800000) {
        return "";
    }
...
Graph.prototype.initialize = function() {
    ...
    for(let i in options.activeAlerts) {
        ...
        options.activeAlerts[i].ActiveAt = mustacheFormatDate(options.activeAlerts[i].ActiveAt);
        options.activeAlerts[i].FiredAt = mustacheFormatDate(options.activeAlerts[i].FiredAt);
        options.activeAlerts[i].ResolvedAt = mustacheFormatDate(options.activeAlerts[i].ResolvedAt);
