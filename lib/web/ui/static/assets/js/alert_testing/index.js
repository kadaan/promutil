...
Graph.prototype.initialize = function() {
    ...
    for(let i in options.activeAlerts) {
        ...
        options.activeAlerts[i].ActiveAt = mustacheFormatDate(options.activeAlerts[i].ActiveAt*1000);
        options.activeAlerts[i].FiredAt = mustacheFormatDate(options.activeAlerts[i].FiredAt*1000);
        options.activeAlerts[i].ResolvedAt = mustacheFormatDate(options.activeAlerts[i].ResolvedAt*1000);
